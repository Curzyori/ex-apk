...
1. **APK をダウンロード**
   - 最新の APK を [GitHub Releases](https://github.com/Curzyori/ex-apk/releases){:target="_blank" rel="noopener noreferrer"} から取得
   - またはサイトへ：[ex-apk.curzy.dev](https://ex-apk.curzy.dev/){:target="_blank" rel="noopener noreferrer"}
...
# ダウンロード：[GitHub Releases](https://github.com/Curzyori/ex-apk/releases){:target="_blank" rel="noopener noreferrer"}
...
<p align="center">
  <table align="center">
    <tr>
      <td align="center"><img src="images/dashboard.jpg" alt="ExAPK ダッシュボード" width="250"/></td>
      <td align="center"><img src="images/extrack-preview.jpg" alt="APK 抽出プレビュー" width="250"/></td>
    </tr>
    <tr>
      <td align="center"><img src="images/setting-lang-preview.jpg" alt="言語設定" width="250"/></td>
      <td align="center"><img src="images/file-output-preview.jpg" alt="抽出された APK ファイル" width="250"/></td>
    </tr>
  </table>
</p>
